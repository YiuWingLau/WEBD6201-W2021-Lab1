...
(function()
{
    ...
    function displayProjects()
    {
      ...
      project.setAttribute("class", "row");
      project.setAttribute("id", "projectOne");
      projectOne = `<div class="col-4"> My favourite projects</div><div class="col-8"> My favourite projects</div>`;
      mainContent.appendChild(project);
