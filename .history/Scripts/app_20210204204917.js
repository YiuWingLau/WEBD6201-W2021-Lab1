...
(function()
{
    ...
    function displayProjects()
    {
      ...
      projectOne.innerHTML = `<div class="row"><div class="col-4"><img id="favHardware" src="./hardware.jpg alt="Hardware Compontent"></div><div class="col-8"> My favourite projects</div></div>`;
