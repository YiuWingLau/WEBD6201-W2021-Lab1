...
(function()
{
    ...
    function addNewNavBarElement()
    {
        ...
        newElementList.setAttribute("id", "navBarHumanResources");
        newElementList.setAttribute("class", "nav-item");
        newElementList.innerHTML = `<a class='nav-link' aria-current='page' href='Human-Resources.html'><i class="fas fa-cog fa-lg"></i> Human Resources</a>`;
