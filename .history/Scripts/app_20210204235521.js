...
(function()
{
    ...
    function displayServices()
    {
      ...
      serviceTwo.innerHTML = `<td><img id="favImage" src="./images/mainframe.jpg" alt="mainframe development"></td>
                              <td><p> We develop softwares for mainframe systems.</p></td>`;
      ...
      serviceThree.innerHTML = `<td><img id="favImage" src="./images/networking.jpg" alt="computer networking"></td>
                                <td><p> We can help with constructing network for your company. We are good at web design and development of web pages that fits your need.</p></td>`;
