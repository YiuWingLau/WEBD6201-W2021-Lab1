...
(function()
{
    ...
    function displayAbout()
    {
                ...
                let myPicture = `<img src="./images/img_me.jpg" alt="Nelson Lau">`;
                ...
                mainContent.appendChild(newParagraph);
                newParagraph.className = "fs-6";
                mainContent.innerHTML = myPicture;
    }
    ...
    function changeNavBarName()
    {
        ...
        let correctName = document.createElement("a");
        correctName.innerHTML = '<i class="fas fa-cog fa-lg"></i> Projects';
        NavName.parentNode.replaceChild(CorrectName, NavName);
