...
(function()
{
    ...
    function addNewNavBarElement()
    {
        ...
        newListElement.innerHTML = `<a class='nav-link' aria-current='page' href='Human-Resources.html'><i class="fas fa-globe-stand fa-lg"></i></i> Human Resources</a>`;
        
        let aboutUsListElement = document.getElementById("navBarAbout");
