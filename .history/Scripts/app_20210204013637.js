...
(function()
{
    ...
    {
        // Step 1. document.createElement
        let pictureZone = document.createElement("div");
        let myPicture = `<img id="myImage" src="./images/img_me.jpg" alt="Nelson Lau" width="160" height="120">`;
        pictureZone.innerHTML = myPicture;

                //create new element Human Resources
        let paragraphZone = document.createElement("div");
