...
(function()
{
    ...
    function displayProjects()
    {
      ...
      projectOne.innerHTML = `<div class="row"><div class="col-4"><img id="favImage" src="./images/hardware.jpg" alt="computer hardware"></div>
                              <div class="col-8"><p> We have a great knowledge on building a computer up below 5 minutes.</p></div></div><div></div>`;
      ...
      projectTwo.innerHTML = `<div class="row"><div class="col-4"><img id="favImage" src="./images/mainframe.jpg" alt="mainframe development"></div>
                              <div class="col-8"><p> We have successfully to help several companies building up their mainframe systems.</p></div></div><div></div>`;
      ...
      projectThree.innerHTML = `<div class="row"><div class="col-4"><img id="favImage" src="./images/networking.jpg" alt="computer networking"></div>
                                <div class="col-8"><p> We have successfully to help several companies building up their network.</p></div></div><div></div>`;
