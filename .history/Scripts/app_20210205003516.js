...
(function()
{
    ...
    function displayProjects()
    {
      ...
      projectThree.innerHTML = `<td><img id="favImage" src="./images/networking.jpg" alt="computer networking"></td>
                                <td><h4> Web Development</h4><p> Created server-side web applications using the PHP scripting language and achieved database functionality with performing SQL queries running on the server.</p></td>`;
