...
(function()
{
    ...
    function displayServices()
    {
     ...
     // service.setAttribute("id", "service");
      ...
      serviceOne.innerHTML = `<div class="row"><div class="col-6"><img id="favImage" src="./images/hardware.jpg" alt="computer hardware"></div>
                              <div class="col-6"><p> We have a great knowledge on building a computer up below 5 minutes.</p></div></div>`;
