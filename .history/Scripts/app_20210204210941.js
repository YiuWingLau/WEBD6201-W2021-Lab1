...
(function()
{
    ...
    function displayProjects()
    {
      ...
      projectOne.innerHTML = `<div class="row"><div class="col-6"><img id="favImage" src="./images/hardware.jpg" alt="computer hardware"></div><div class="col-6"><p> My favourite projects</p></div></div>`;
