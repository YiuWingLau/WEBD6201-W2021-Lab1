...
(function()
{
    ...
    function displayProjects()
    {
      ...
      projectOne.innerHTML = `<div class="row"><div class="col-6"><img id="favHardware" src="./images/hardware.jpg" alt="computer hardware"></div><div class="col-6"><p> My favourite projects</p></div></div>`;
      ...
      projectTwo.innerHTML = `<div class="row"><div class="col-4"><img id="favHardware" src="./images/mainframe.jpg" alt="mainframe development"></div><div class="col-8"> My favourite projects</div></div>`;
      ...
      projectThree.innerHTML = `<div class="row"><div class="col-4"> C++ Programming</div><div class="col-8"> My favourite projects</div></div>`;
