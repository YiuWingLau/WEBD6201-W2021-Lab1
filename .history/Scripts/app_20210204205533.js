...
(function()
{
    ...
    function displayProjects()
    {
      ...
      projectOne.innerHTML = `<div class="row"><div class="col-6"><img id="favHardware" src="./images/hardware.jpg" alt="Hardware Compontent"></div><div class="col-6"><p> My favourite projects</p></div></div>`;
      ...
      projectTwo.innerHTML = `<div class="row"><div class="col-4"> Wed Design & Development</div><div class="col-8"> My favourite projects</div></div>`;
