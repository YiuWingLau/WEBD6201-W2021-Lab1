...
(function()
{
    ...
    function displayProjects()
    {
      ...
      projectOne.textContent = `<div class="col-4"> My favourite projects</div><div class="col-8"> My favourite projects</div>`;

      let projectContent = document.getElementsById("project")[0];
