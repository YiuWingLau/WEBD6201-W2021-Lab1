...
(function()
{
    ...
    function displayProjects()
    {
      ...
      projectOne.innerHTML = `<div class="row"><div class="col-6"><img id="favImage" src="./images/hardware.jpg" alt="computer hardware"></div><div class="col-6"><p> My favourite projects</p></div></div><div></div>`;
      ...
      projectTwo.innerHTML = `<div class="row"><div class="col-4"><img id="favImage" src="./images/mainframe.jpg" alt="mainframe development"></div><div class="col-8"> My favourite projects</div></div><div></div>`;
      ...
      projectThree.innerHTML = `<div class="row"><div class="col-4"><img id="favImage" src="./images/networking.jpg" alt="computer networking"></div><div class="col-8"> My favourite projects</div></div><div></div>`;
