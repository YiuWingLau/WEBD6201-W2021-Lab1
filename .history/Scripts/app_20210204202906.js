...
(function()
{
    ...
    function displayProjects()
    {
      ...
      project.innerHTML = `<div class="row"><div class="col-4"> My favourite projects</div><div class="col-8"> My favourite projects</div></div>`;

      let projectContent = document.getElementsById("project");
      projectContent.appendChild(projectOne);
      //projectTwo = `<div class="row"><div class="col-4"> My favourite projects</div><div class="col-8"> My favourite projects</div></div>`;
      //projectThree = `<div class="row"><div class="col-4"> My favourite projects</div><div class="col-8"> My favourite projects</div></div>`;
